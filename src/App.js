...
class App extends Component {
  ...
  _toBase64(){
    this.humanBody.svgBody.toDataURL(base64 => {
        console.log(base64);
    });
    // console.log(this.humanBody)
  }
  ...
  render() {
    return (
      <View style={{flex:1, justifyContent: "space-around"}}>
        ...
        <View style={{flex:0.6}}>
          <View style={{height:420, width:320, alignSelf:"center", borderWidth: 0.5}}>
            <Human selected={this.state.selected} ref={(human) => this.humanBody = human}/>
          </View>
        </View>
        <View style={{flex: 0.2, flexDirection:"row", justifyContent: "space-around",}}>
          <View style={{justifyContent: "space-around", flex:1, alignItems:"center", backgroundColor:"mintcream"}}>
            <Button title={"To base64"} onPress={() => {this._toBase64()}}/>
